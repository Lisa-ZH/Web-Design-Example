jQuery(document).ready(function () {
	function close_accordion_section() {
		...
		jQuery('.header-inside .hamburger-content').removeClass('open');
	}
	...
	jQuery('.hamburger-title').click(function (e) {
		...
		if (jQuery(e.target).is('.active')) {
			...
			jQuery('.header-inside ' + currentAttrValue).addClass('open');
		}
...
jQuery(document).ready(function () {
	function close_accordion_section() {
		...
		jQuery('.mobile-search-button').text("Search Job Opportunities");
...
jQuery(function($){
	$('.nav-column .icon-wrap').on('click', function(e){
		console.log(this);
		$(this).toggleClass('is-open');
		$(this).parent().siblings('ul').toggleClass('is-open');
	});
	$(document).on('click', '.footer-sub-menu-button', function(e){
		var boo = true;
		if($(this).hasClass('is-open')) {
			boo = false;
		}
		$(this).toggleClass('is-open');
		$(this).siblings('ul').toggleClass('is-open').attr('aria-expanded', boo);
	});
	$('.accordion .accordion-header button').on('click', function(e){
