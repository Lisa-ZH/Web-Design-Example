...
(function ($) {
	...
	window.AblePlayer = function(media) {
		...
		// 1. Lang attributes on <html lang="en"> or <body>, if a matching translation file is available
...
(function ($) {
	...
	AblePlayer.prototype.handleTranscriptLockToggle = function (val) {
		...
		this.autoScrollTranscript = 0; // val is boolean
